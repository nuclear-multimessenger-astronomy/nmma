...
from .model import SupernovaLightCurveModel, SupernovaGRBLightCurveModel, KilonovaGRBLightCurveModel
...
def main():
    ...
    if args.joint_light_curve:
        ...
        if args.model == 'TrPi2018':
            ...
            light_curve_model = SupernovaLightCurveModel(sample_times=sample_times,
                                                         model=args.model)
    ...
    for index, row in injection_df.iterrows():
        ...
        data = create_light_curve_data(
            injection_parameters, args, doAbsolute=args.absolute,
    ...
    if args.plot:
        ...
        plotName = os.path.join(args.outdir, 'injection_' + args.model + '_lightcurves.pdf')
