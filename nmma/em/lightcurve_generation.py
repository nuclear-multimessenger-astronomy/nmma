...
from .analysis import create_detection_limit
...
def arnett_lc_get_int_A(x,y):
    return np.vectorize(arnett_lc_get_int_A_non_vec, excluded=["y"])
...
def arnett_lc_get_int_B(x, y, s):
    return np.vectorize(arnett_lc_get_int_B_non_vec, excluded=["y", "s"])
