...
def eos_parsing(parser):
    ...
    eos_input_parser.add("--eos-constraint-json", type = nonestr,
    ...
    eos_input_parser.add( "--lower-mtov", type=nonestr,
    ...
    eos_input_parser.add( "--lower-mtov-name", type=nonestr, action = 'append',
        help= "list of identifiers for further lower-mtov-values to consider" )
    eos_input_parser.add( "--lower-mtov-mass", type=nonestr, action = 'append',
        help= "list of additional lower mtov limits to consider" )
    eos_input_parser.add( "--lower-mtov-error",type=nonestr, action = 'append',
        help= "list of additional mtov limit errors to consider")
    eos_input_parser.add( "--lower-mtov-arxiv",type=nonestr, action = 'append',
        help= "list of arxiv-ids for additional lower mtov limits to consider")
    
    ### setup UpperMTOVConstraint
    eos_input_parser.add( "--upper-mtov", type=nonestr,
    ...
    eos_input_parser.add( "--upper-mtov-name", type=nonestr, action = 'append',
        help= "list of identifiers for further upper-mtov-values to consider")
    eos_input_parser.add( "--upper-mtov-mass", type=nonestr, action = 'append',
        help= "list of additional upper mtov limits to consider")
    eos_input_parser.add( "--upper-mtov-error",type=nonestr, action = 'append',
        help= "list of additional mtov limit errors to consider")
    eos_input_parser.add( "--upper-mtov-arxiv",type=nonestr, action = 'append',
        help= "list of arxiv-ids for additional upper mtov limits to consider")

    ### setup MassRadiusConstraint
    eos_input_parser.add( "--mass-radius", type=nonestr,
    ...
    eos_input_parser.add(  "--mass-radius-name", type=nonestr, action = 'append',
        help= "list of identifiers for further mass-radius-posteriors to consider")
    eos_input_parser.add("--MR-posterior-file-path",type=nonestr,action='append',
        help= "list of files with additional radius-mass posteriors to consider")
    eos_input_parser.add( "--mass-radius-arxiv", type=nonestr, action = 'append',
