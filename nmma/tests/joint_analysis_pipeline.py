...
from nmma.em import analysis, model, em_parsing
...
em_args = em_parsing.parsing_and_logging(em_parsing.em_analysis_parser, [])
main_args = Namespace(
    label="injection",
...
def test_injection_creation(args):
    ...
    inj_model = model.create_light_curve_model_from_args(args.em_model, args, args.filters)    

    data, injection_parameters =analysis.make_injection(args, injection_model=inj_model)
