...
def resampling_parser(parser):
    ...
    parser.add_argument(
        "--GWprior", required=True, help="Prior file used for the GW analysis"
    )
    parser.add_argument(
        "--EMprior", required=True, help="Prior file used for the EM eos analysis"
    )
    parser.add_argument(
        "--total-ejecta-mass",
        action="store_true",
...
def lc_marginalisation_parser(parser):
    ...
    # specific arguments
    parser.add_argument("--template-file", help="The template file to be used")
