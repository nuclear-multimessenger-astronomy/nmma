...
# -*- coding: utf-8 -*-
#
# nmma documentation build configuration file, created by
# sphinx-quickstart on Thu Jul 23 13:00:45 2015 (copied from `nmma`).
#
...
# create entity relationship diagram for nmma
