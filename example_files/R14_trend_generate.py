...
# user specify input
pdet_Mmax_path = '/home/%s/nmma/example_files/eos/pdet_of_Mmax.dat'%(os.environ['USER'])
EOS_prior_path = '/home/%s/nmma/example_files/eos/EOS_sorted_weight.dat'%(os.environ['USER'])
EOSset_path = '/home/%s/nmma/example_files/eos/eos_sorted'%(os.environ['USER'])
GWEMdata_path =  '/home/%s/nmma/output/GW_EMdata'%(os.environ['USER'])
label = 'ZTF'
Neos = 5000
# load the detectable events
detectable = np.loadtxt('/home/%s/nmma/example_files/csv_lightcurve/detectable.txt'%(os.environ['USER'])).astype(int)
# load the EOS prior
...
df.to_csv('GW_EM_R14trend_{0}.dat'.format(label), index=False, sep=' ')
